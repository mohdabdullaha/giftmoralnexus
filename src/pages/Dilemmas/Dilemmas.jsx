                            ...
                            <ul className="space-y-6">
                                {data.scenarios.map((item, idx) => (
                                    <motion.li
                                        ...
                                        className="bg-white p-5 rounded-xl shadow-sm border border-ice-border text-gray-700 text-lg leading-relaxed list-disc list-inside marker:text-green marker:text-2xl"
                                    >
                                        {item}
                                    </motion.li>
                                ))}
