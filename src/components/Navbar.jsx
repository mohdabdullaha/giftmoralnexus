...
const Navbar = ({ pageTitle }) => {
    ...
    const navLinks = [
        { title: "Home", path: "/" },
        { title: "Cardinal Virtue", path: "/truthfulness" },
        { title: "Raz E Hayat", path: "/razehayat" },
        { title: "Infographic", path: "/infographics" },
    ...
    return (
        <nav className="flex flex-col w-full shadow-lg z-50 sticky top-0 bg-navy">
            {/* Top Header */}
            <div className="bg-navy text-white px-4 md:px-6 py-4 flex flex-col md:grid md:grid-cols-[auto_1fr_auto] items-center gap-4 border-b border-white/5">
                ...
                <div className="text-center">
                    <h2 id="siteTitle" className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold tracking-[0.05em] md:tracking-[0.2em] animate-intro-zoom text-white mx-auto">
